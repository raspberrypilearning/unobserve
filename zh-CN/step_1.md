...
以下是 [更多 Web](https://projects.raspberrypi.org/en/raspberrypi/more-web) 路径中的 [动画故事](https://projects.raspberrypi.org/en/projects/animated-story) 项目使用  `unobserve` 的示例：
